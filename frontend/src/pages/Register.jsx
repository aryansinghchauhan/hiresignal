  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: 'calc(100vh - 60px)', padding: '32px' }}>
      <div style={{ background: '#1e293b', borderRadius: '12px', padding: '32px', width: '100%', maxWidth: '400px', border: '1px solid #334155' }}>
        ...
        <p style={{ color: '#94a3b8', marginBottom: '24px', fontSize: '14px' }}>Start analyzing your resume for free</p>
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: '16px' }}>
            <label style={{ display: 'block', marginBottom: '6px', fontSize: '14px', color: '#94a3b8' }}>Name</label>
            <input type="text" placeholder="Aryan Singh" value={form.name}
